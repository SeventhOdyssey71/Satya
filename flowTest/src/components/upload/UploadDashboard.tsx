      ...
      <div className="border-b border-gray-200">
        <nav className="flex gap-6">
          {[
            ...
            { id: 'history', label: 'History', icon: IoTime },
            { id: 'settings', label: 'Settings', icon: IoCog }
          ...
          {taskCount.active > 0 && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-center gap-2 mb-4">
                <IoRefresh className="w-5 h-5 text-black animate-spin" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                ...
                <IoTime className="w-8 h-8 text-yellow-500" />
              </div>
            </div>
...
function StatCard({ title, value, icon: Icon, color, trend }: StatCardProps) {
  ...
  const trendIcon = {
    up: <IoTrendingUp className="w-4 h-4 text-green-500" />,
    down: <IoTrendingUp className="w-4 h-4 text-red-500 rotate-180" />,
