...
export default function UploadHistory({ 
 ...
 const { clearCompletedTasks, clearFailedTasks, clearAllTasks, removeUploadTask, cancelUploadTask } = useUploadActions()
   ...
   <div className="flex items-center justify-between mb-4">
    ...
    <div className="flex items-center gap-2">
     ...
     <button
      ...
      disabled={taskCount.failed === 0}
      className="px-3 py-1 text-sm text-orange-600 hover:text-orange-800 disabled:opacity-50 disabled:cursor-not-allowed"
     >
      Clear Failed
     </button>
     <button
