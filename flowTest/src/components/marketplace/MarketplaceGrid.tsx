      ...
      <div className="card-interactive overflow-hidden h-full">
        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between mb-3">
            <h3 className="text-xl font-russo text-secondary-900 group-hover:text-primary-600 transition-colors line-clamp-2 flex-1">
              {model.title}
            </h3>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full flex items-center justify-center text-white text-xs font-medium">
